...
void testJumble() {
	...
	// JumblePuzzle* jp5;
	// try {
	// 	jp5 = new JumblePuzzle('hi', "easy");
	// } catch (BadJumbleException& e) {
	// 	cerr << e.what();
	// }
	// cout<< "Should print: String is not big enough"<<endl;
	// //Implemented Test for a small hidden word
	// JumblePuzzle* jp6;
	// try {
	// 	jp6 = new JumblePuzzle('abcdefghijk', "easy");
	// } catch (BadJumbleException& e) {
	// 	cerr << e.what();
	// }
	// cout<< "Should print: String is too big"<<endl;
	// //Implemented Test for a large hidden word
	// JumblePuzzle* jp7;
	// try {
	// 	jp7 = new JumblePuzzle('whatever', "something");
	// } catch (BadJumbleException& e) {
	// 	cerr << e.what();
	// }
	// cout<< "Should print: Difficulty not in scope"<<endl;
	// //Implemented Test for a difficulty inputted that doesn't exist
